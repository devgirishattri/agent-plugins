---
name: context-verify
description: Verify a structured handoff's local file and commit evidence against an explicitly bound Git repository, without changing stores or executing recorded commands.
---

# Context Verify

Resolve the absolute plugin root from this installed skill's source path, two
directories above this file. Substitute that path for `<PLUGIN_ROOT>`; never
...
[handoff contract](../knowledge/references/handoffs.md).
