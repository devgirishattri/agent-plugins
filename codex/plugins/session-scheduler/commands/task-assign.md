...
4. Flags:
   ...
   - `--context NAME|auto` — attach an existing snapshot, or create an immutable task-scoped handoff.
...
6. On dispatch failure the ledger is NOT updated; the prompt and any automatic context are rolled back. Successful dispatch records the absolute shared homes for the recipient.
