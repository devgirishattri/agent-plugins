...
run_sender() {
  TMUX="$TMUX_ENV" TMUX_PANE="$SENDER" CODEX_HOME="$TEST_HOME" SESSION_CHAT_ROOT_OVERRIDE="$SESSION_CHAT_ROOT" "$@"
}

run_recipient() {
  TMUX="$TMUX_ENV" TMUX_PANE="$RECIPIENT" CODEX_HOME="$TEST_HOME" SESSION_CHAT_ROOT_OVERRIDE="$SESSION_CHAT_ROOT" "$@"
}
