#!/usr/bin/env bash
# detect-snapshots.sh — SessionStart hook for session-context.
...
echo "session-context: ${count} context snapshot(s) available for this project: ${names}. Run /context-load <name> to resume prior work, or /context-list for details."
exit 0
